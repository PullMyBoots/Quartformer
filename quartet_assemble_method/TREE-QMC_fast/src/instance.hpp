...
class Instance {
    ...
    private:
        ...
        void refine_trees();
        void input_quartets();
        void input_quartets(std::istream &in);
        void input_quartets_basic();
        void input_quartets_basic(std::istream &in, const std::string *first_line);
        void input_quartets_phylonetworks();
        void input_quartets_phylonetworks(std::istream &in);
        void input_quartets_binary(std::istream &in);
        //void input_pvalues();
};
