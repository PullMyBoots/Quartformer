...
def simulate_phylogeny(path, species_num, tree_num, root=False, append_mode=False):
    ...
    for i in range(tree_num):
        ...
        # 使用均值为0.1的指数分布设置分支长度
        scales = np.array([0.02, 0.05, 0.1, 0.2, 0.5])
        pi = np.array([1/5, 1/5, 1/5, 1/5, 1/5])        # 或据经验设定/学习
...
if __name__ == "__main__":
    ...
    for species_num in [24, 48, 96, 192]:
        ...
        for dna_length in [100000, 1000000, 10000000]:
